...
export const appointmentRequestSchema = z.object({
  parentName: z
    .string()
    .trim()
    .min(2, "Parent name must contain at least 2 characters")
    .max(80),
  childName: z
    .string()
    .trim()
    .min(2, "Child’s name must contain at least 2 characters")
    .max(80),
  ...
  consent: z.literal(true, {
    error: "Consent is required to request an appointment",
  }),
});
